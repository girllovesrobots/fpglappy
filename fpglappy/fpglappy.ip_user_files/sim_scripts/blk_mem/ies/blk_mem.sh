...
#
# Generated by Vivado on Wed Dec 02 17:01:00 EST 2015
...
# Script info
echo -e "blk_mem.sh - Script generated by export_simulation (Vivado v2015.3 (64-bit)-id)\n"
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./blk_mem.sh -help\" for more information)\n"
  exit 1
fi
...
compile()
{
  ...
  ncvlog -work xil_defaultlib $opts_ver \
    "$ref_dir//home/jmend/Documents/fpglapls/fpglappy/fpglappy/fpglappy.srcs/sources_1/ip/blk_mem/blk_mem_sim_netlist.v" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.blk_mem xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.blk_mem -input simulate.do
}
# Script usage
usage()
{
